  ...
  <div className="main-card">
    <div className="card-1">
      ...
      <p className="description">
        Create your <span className="highlight">Digital Classroom</span> in 5
        mins for <span className="highlight">FREE</span> & connect to 1+ Million
        Students.
      </p>
      ...
      <ul className="ul-list">
        <li className="item">No technical knowledge required.</li>
        <li className="item">
